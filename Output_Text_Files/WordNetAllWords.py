...
with open('AllDistinctWords.txt', 'r') as infile: # open the plain text file that contains the list of words
    wordlist = infile.read().split() # read the words into a list, splitting on the new lines
with open('synset_info_adw.xml', 'w') as outfile: # open a file to hold the XML output
